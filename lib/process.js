...
Process.prototype.cleanup = function (properties, timer, triggers, files, fileList) {
    /*****************************
     * Cleanup
     */     
    // Case: user manually stopped script
    if (timer.isStopped()) {
        saveState(properties, fileList, "Stopped manually by user.  Please use 'Resume' button to restart copying");
    ...
    // Case: maximum execution time has been reached
        ...
        saveState(properties, fileList, "Paused due to Google quota limits - copy will resume in 1-2 minutes");
