...
Properties.prototype.addMapping = function (key, value) {
    // TODO: need to either add a polyfill or refactor this, GAS doesn't support Object.assign
...
Properties.prototype.setTimezone = function (timezone) {
    if (!(timezone === undefined || timezone === null)) {
        this.timeZone = timezone;
    }
};

Properties.prototype.getTimezone = function () {
    return this.timeZone || 'GMT';
};
