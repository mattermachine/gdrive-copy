...
Properties.prototype.setUserPropertiesStore = function(props) {
    ...
    userProperties.setProperty("destId", props.destId);
    userProperties.setProperty("spreadsheetId", props.spreadsheetId);
    userProperties.setProperty("propertiesDocId", props.propertiesDocId);
    userProperties.setProperty("trials", 0);
    userProperties.setProperty("resuming", props.resuming);
