...
Properties.prototype.addMapping (key, value) {
    this._mapping = Object.assign({}, this._mapping, createObject(key, value));
}

Properties.prototype.getMapping (key) {
    return this._mapping[key];
}

// just an alias, not sure which naming is more intuitive
Properties.prototype.getDestFrom (key) {
    return this.getMapping(key);
}

Properties.prototype.addToRemaining (folderId) {
    this._remaining.push(folderId);
}

Properties.prototype.getNextRemaining () {
    return this._remaining.pop();
}

// return {number}
Properties.prototype.getNumberRemaining () {
    return this._remaining.length;
}

// return {boolean}
Properties.prototype.noneRemaining () {
    return this.getNumberRemaining === 0;
}

Properties.prototype.shouldCopyPermissions () {
    return this._shouldCopyPermissions;
}

Properties.prototype.setShouldCopyPermissions (bool) {
