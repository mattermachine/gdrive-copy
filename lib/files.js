 ...
 */
var insertDestinationFolder = R.curry(function (Drive, selectedFolder, today) {
    var destFolder;
...
Files.prototype._buildErrorResult = buildResult(true);
Files.prototype._buildSuccessResult = buildResult(false, null);


/////////////////////////////
// 
// Instantiate the prototype functions with this.Drive
// 
/////////////////////////////
Files.prototype.copyFileToDrive = copyFile(this.Drive);
Files.prototype.copyFolderToDrive = copyFolder(this.Drive);
Files.prototype.getFiles = listFiles(this.Drive);
Files.prototype.createLoggerSpreadsheet = copyLoggerSpreadsheet(this.Drive);
Files.prototype.initializeDestinationFolder = insertDestinationFolder(this.Drive);
