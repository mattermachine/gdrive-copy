 ...
 */
Files.prototype.fileListExists = function (key) {
    return (this._exists(this._fileList) &&
        this._fileList.length !== 0);
};

Files.prototype._exists = function (prop) {
...
if (module !== undefined) {
    module.exports['isNativeGoogleType'] = Files.prototype.isNativeGoogleType;
}
